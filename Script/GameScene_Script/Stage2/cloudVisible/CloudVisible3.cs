...
public class CloudVisible3 : Photon.Bolt.GlobalEventListener
{
    public GameObject nextcloudrs4;
    ...
    private void Start()
    {/*
        nextcloudrs = Resources.Load<GameObject>($"UI_pref/SpawnObject/Stage2/Cloud4");
        spawnPos = GameObject.Find("cloudSpawn4").transform.position;
        */
    }
    ...
    {
        if (evnt.setActive == true && evnt.numOfcloud == 4)
        {
            nextcloudrs4.SetActive(true);
        }
    }
}
